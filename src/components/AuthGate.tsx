...
import { ShieldAlert, Terminal, HelpCircle, Loader2 } from 'lucide-react';
...
/                                                \\
|   C A M P U S   S T U D Y   G P T   V 1 . 0    |
\\_  _  _  _  _  _  _  _  _  _  _  _  _  _  _  _  /`}
        </pre>
        ...
        <form onSubmit={handleEmailAuth} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3 pt-2">
            <button
              ...
              className="retro-button text-xs py-2.5 flex items-center justify-center gap-2"
            >
              {loading ? (
        ...
        {/* Toggle Mode */}
        <div className="mt-6 text-center border-t border-dashed border-white/20 pt-4">
          <button
            type="button"
            onClick={() => {
